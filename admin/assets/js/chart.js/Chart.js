...
//               } else if ((s = t.match(i))) {
//                 for (var u = 0; u < o.length; u++) o[u] = parseInt(s[u + 1]);
//                 l = parseFloat(s[4]);
//               } else if ((s = t.match(a))) {
//                 for (var u = 0; u < o.length; u++)
...
//                 n = (e[0] + t) % 360;
//               return (
//                 (e[0] = 0 > n ? 360 + n : n), this.setValues("hsl", e), this
//               );
//             },
//             mix: function (t, e) {
//               var n = this,
...
//               o = t[2] / 100;
//             return (
//               (e = 3.2406 * a + -1.5372 * r + o * -0.4986),
//               (n = a * -0.9689 + 1.8758 * r + 0.0415 * o),
//               (i = 0.0557 * a + r * -0.204 + 1.057 * o),
//               (e =
//                 e > 0.0031308
...
//             return (
//               8 >= r
//                 ? ((n = (100 * r) / 903.3), (a = 7.787 * (n / 100) + 16 / 116))
...
//               (i =
//                 0.008859 >= i / 108.883
//                   ? (i = (108.883 * (a - l / 200 - 16 / 116)) / 7.787)
//                   : 108.883 * Math.pow(a - l / 200, 3)),
//               [e, n, i]
//             );
//           }
//           function B(t) {
...
//             },
//             Z = {};
//           for (var Q in J) Z[JSON.stringify(J[Q])] = Q;
//         },
//         {},
//       ],
//       5: [
...
//                   return (
//                     (u = Math.min(
//                       e.getValueOrDefault(i.barThickness, u),
...
//                           ((0 > f && 0 > a) || (f >= 0 && a > 0)) && (m += a));
//                   return (
//                     (r = c.getPixelForValue(m)),
//                     (o = c.getPixelForValue(m + f)),
//                     (l = (o - r) / 2),
//                     { size: l, base: r, head: o, center: o + l / 2 }
//                   );
//                 },
...
//                     (l += n.barSpacing / 2),
//                     { size: s, base: l, head: l + s, center: l + s / 2 }
//                   );
//                 },
//                 draw: function () {
//                   var t,
...
//                     o = n.custom || {},
//                     l = n._model;
//                   l.radius = o.hoverRadius
//                     ? o.hoverRadius
//                     : e.getValueAtIndexOrDefault(
//                         a.hoverRadius,
//                         r,
//                         i.chart.options.elements.point.hoverRadius
//                       ) + i.getRadius(a.data[r]);
//                 },
...
//                     return (
//                       e.isArray(i) ? ((i = i.slice()), (i[0] += a)) : (i += a),
//                       i
//                     );
//                   },
//                 },
...
//               e.extend(n.pie, { cutoutPercentage: 0 }),
...
//                       (n.outerRadius =
//                         i.outerRadius -
//                         i.radiusLength * n.getRingIndex(n.index)),
//                       (n.innerRadius = Math.max(
//                         n.outerRadius - i.radiusLength,
//                         0
//                       )),
...
//                           : t.hidden
//                           ? 0
//                           : a.calculateCircumference(f.data[n]) *
...
//                       (i && s.animateRotate) ||
//                         (0 === n
//                           ? (b.startAngle = l.rotation)
//                           : (b.startAngle =
//                               a.getMeta().data[n - 1]._model.endAngle),
...
//                         tension: r.tension
//                           ? r.tension
//                           : n.getValueOrDefault(f.lineTension, c.tension),
...
//                           ? r.steppedLine
//                           : n.getValueOrDefault(f.steppedLine, c.stepped),
...
//                       ? (i = n.getValueAtIndexOrDefault(
//                           a.pointBackgroundColor,
//                           e,
//                           i
//                         ))
//                       : a.backgroundColor && (i = a.backgroundColor),
//                     i
//                   );
//                 },
...
//                         ? isNaN(a.borderWidth) || (i = a.borderWidth)
//                         : (i = n.getValueAtIndexOrDefault(
//                             a.pointBorderWidth,
//                             e,
//                             i
...
//                     m =
//                       1 === p.length || 1 === u.data.length || o.chart.isCombo;
//                   void 0 !== u.radius &&
...
//                       radius:
//                         s.radius ||
//                         n.getValueAtIndexOrDefault(u.pointRadius, e, g.radius),
//                       pointStyle:
//                         s.pointStyle ||
...
//                         (r = a._model),
//                         (o = n.splineCurve(
//                           n.previousItem(d, e)._model,
//                           r,
//                           n.nextItem(d, e)._model,
...
//                     for (e = 0, i = d.length; i > e; ++e)
//                       (r = d[e]._model),
//                         (r.controlPointPreviousX = t(
//                           r.controlPointPreviousX,
//                           u.left,
//                           u.right
//                         )),
//                         (r.controlPointPreviousY = t(
//                           r.controlPointPreviousY,
//                           u.top,
//                           u.bottom
//                         )),
//                         (r.controlPointNextX = t(
//                           r.controlPointNextX,
//                           u.left,
//                           u.right
//                         )),
//                         (r.controlPointNextY = t(
//                           r.controlPointNextY,
//                           u.top,
//                           u.bottom
//                         ));
...
//                     s = 0;
//                   for (
//                     t.canvasHelpers.clipArea(i.ctx, o),
//                       e(n.getDataset(), i.options) && a.dataset.draw(),
//                       t.canvasHelpers.unclipArea(i.ctx);
//                     l > s;
//                     ++s
//                   )
//                     r[s].draw(o);
...
//                         i,
//                         n.getHoverColor(r.backgroundColor)
//                       )),
//                     (r.borderColor =
//                       a.hoverBorderColor ||
//                       n.getValueAtIndexOrDefault(
...
//                       c = r.data.labels,
//                       h = a.calculateCircumference(o.data[n]),
//                       f = u.xCenter,
//                       g = u.yCenter,
//                       p = 0,
//                       m = a.getMeta(),
...
//                     x = t.hidden
//                       ? 0
//                       : u.getDistanceFromCenterForValue(o.data[n]),
//                     y = b + h * p,
//                     k = y + (t.hidden ? 0 : h),
//                     w = s.animateScale
//                       ? 0
...
//                           : e.getValueOrDefault(
//                               o.lineTension,
//                               a.chart.options.elements.line.tension
//                             ),
//                         radius: r.radius
//                           ? r.radius
//                           : e.getValueAtIndexOrDefault(
...
//                     var r = i._model,
//                       o = e.splineCurve(
//                         e.previousItem(n.data, a, !0)._model,
//                         r,
//                         e.nextItem(n.data, a, !0)._model,
//                         r.tension
//                       );
...
//                   (r.radius = i.radius
//                     ? i.radius
//                     : e.getValueAtIndexOrDefault(n.pointRadius, a, o.radius)),
...
//                   });
//                   -1 !== n &&
//                     (this.animations.splice(n, 1), (t.animating = !1));
//                 },
...
//                       n.currentStep >= n.numSteps
//                         ? (e.callback(n.onAnimationComplete, [n], i),
//                           (i.animating = !1),
//                           a.splice(r, 1))
//                         : ++r;
//                 },
...
//                         if (
//                           (o.type || (o.type = a.type || e.config.type),
//                           n.push(o.type),
//                           o.controller)
//                         )
...
//                     i = { meta: n, index: t };
//                   r.notify(e, "beforeDatasetUpdate", [i]) !== !1 &&
//                     (n.controller.update(),
...
//                         ("undefined" == typeof e && 0 !== o.duration))
//                     ) {
...
//                     } else
//                       i.draw(), l(new t.Animation({ numSteps: 0, chart: i }));
//                     return i;
//                   }
//                 },
//                 draw: function (t) {
...
//                   r.notify(n, "beforeDatasetDraw", [a]) !== !1 &&
//                     (i.controller.draw(e),
...
//                       n.onClick &&
//                       n.onClick.call(e, t["native"], e.active),
//                     e.lastActive.length &&
...
//                     n = e.length,
//                     i = 0;
//                   for (t.dataset && t.dataset.draw(); n > i; ++i) e[i].draw();
//                 },
...
//                     o = i.getHoverColor,
//                     l = t._model;
//                   (l.backgroundColor = a.hoverBackgroundColor
//                     ? a.hoverBackgroundColor
//                     : r(e.hoverBackgroundColor, n, o(l.backgroundColor))),
//                     (l.borderColor = a.hoverBorderColor
//                       ? a.hoverBorderColor
//                       : r(e.hoverBorderColor, n, o(l.borderColor))),
//                     (l.borderWidth = a.hoverBorderWidth
//                       ? a.hoverBorderWidth
//                       : r(e.hoverBorderWidth, n, l.borderWidth));
//                 },
...
//               return u || d
//                 ? Math.min(u ? e(l, t, a) : c, d ? e(s, o, a) : c)
//                 : "none";
//             }
//             var r = (t.helpers = {});
...
//                 else for (a = 0; o > a; a++) e.call(n, t[a], a);
//               else if ("object" == typeof t) {
//                 var l = Object.keys(t);
//                 for (o = l.length, a = 0; o > a; a++) e.call(n, t[l[a]], l[a]);
//               }
//             }),
//               (r.clone = function (t) {
//                 var e = {};
...
//                             var o = r.getValueOrDefault(
//                                 e.type,
//                                 "xAxes" === n ? "category" : "linear"
//                               ),
//                               l = t.scaleService.getScaleDefaults(o);
//                             a >= i[n].length || !i[n][a].type
//                               ? i[n].push(r.configMerge(l, e))
//                               : e.type && e.type !== i[n][a].type
//                               ? (i[n][a] = r.configMerge(i[n][a], l, e))
//                               : (i[n][a] = r.configMerge(i[n][a], e));
//                           })
//                         : ((i[n] = []),
//                           r.each(e, function (e) {
//                             var a = r.getValueOrDefault(
//                               e.type,
//                               "xAxes" === n ? "category" : "linear"
//                             );
//                             i[n].push(
//                               r.configMerge(
//                                 t.scaleService.getScaleDefaults(a),
//                                 e
//                               )
//                             );
//                           }))
...
//                 return void 0 === t ? e : t;
//               }),
//               (r.indexOf = Array.prototype.indexOf
//                 ? function (t, e) {
//                     return t.indexOf(e);
//                   }
//                 : function (t, e) {
...
//                 return (
//                   (n = Math.round(
//                     (((n - l.left - u) / f) * o.width) /
//                       e.currentDevicePixelRatio
//                   )),
//                   (i = Math.round(
//                     (((i - l.top - d) / g) * o.height) /
//                       e.currentDevicePixelRatio
//                   )),
//                   { x: n, y: i }
//                 );
...
//                 var l = 0;
//                 r.each(n, function (e) {
//                   void 0 !== e && null !== e && r.isArray(e) !== !0
//                     ? (l = r.measureText(t, a, o, l, e))
//                     : r.isArray(e) &&
//                       r.each(e, function (e) {
//                         void 0 === e ||
//                           null === e ||
...
//                 var s = o.length / 2;
//                 if (s > n.length) {
//                   for (var u = 0; s > u; u++) delete a[o[u]];
//                   o.splice(0, s);
//                 }
//                 return l;
//               }),
...
//                 ? function (e) {
//                     return (
//                       e instanceof CanvasMega &&
//                         (e = t.defaults.global.defaultColor),
//                       i(e)
//                     );
//                   }
//                 : function (t) {
...
//                   for (
//                     n = t.getDatasetMeta(i), a = 0, o = n.data.length;
//                     o > a;
//                     ++a
//                   ) {
//                     var s = n.data[a];
...
//                           a = n - i;
//                         return (
//                           0 === a && (a = t._datasetIndex - e._datasetIndex), a
//                         );
//                       }),
//                     o.slice(0, 1)
//                   );
...
//                           '"></span>'
//                       ),
//                         t.data.datasets[n].label &&
//                           e.push(t.data.datasets[n].label),
//                         e.push("</li>");
//                     return e.push("</ul>"), e.join("");
//                   },
//                 },
...
//                     n = t.isHorizontal();
//                   n
//                     ? ((e = t.update(t.fullWidth ? k : I, D)), (A -= e.height))
//                     : ((e = t.update(C, S)), (I -= e.width)),
//                     P.push({ horizontal: n, minSize: e, box: t });
//                 }
//                 function l(t) {
...
//                       return e.box === t;
//                     }),
//                     n = { left: 0, right: 0, top: O, bottom: z };
//                   e && t.update(e.minSize.width, A, n);
//                 }
//                 function u(t) {
//                   t.isHorizontal()
//                     ? ((t.left = t.fullWidth ? h : L),
...
//                   if (
//                     (d
//                       ? (a.width = t.isFullWidth()
//                           ? t.maxWidth - t.margins.left - t.margins.right
//                           : t.maxWidth)
//                       : (a.width = u && s.drawTicks ? f : 0),
//                     d
//                       ? (a.height = u && s.drawTicks ? f : 0)
//                       : (a.height = t.maxHeight),
...
//                       0 !== t.labelRotation
//                         ? ((t.paddingLeft =
//                             "bottom" === r.position ? b * w + 3 : b * m + 3),
//                           (t.paddingRight =
//                             "bottom" === r.position ? b * m + 3 : b * S + 3))
//                         : ((t.paddingLeft = w / 2 + 3),
...
//                       if (
//                         ((o = !1),
//                         (M + d.autoSkipPadding) * a.ticks.length >
...
//                     if (
//                       (i.each(a.ticks, function (t, n) {
//                         if (void 0 !== t && null !== t) {
//                           var l = a.ticks.length === n + 1,
//                             s =
//                               (o > 1 && n % o > 0) ||
//                               (n % o === 0 && n + o >= a.ticks.length);
//                           if ((!s || l) && void 0 !== t && null !== t) {
//                             var h, g, m, v;
//                             n ===
//                             ("undefined" != typeof a.zeroLineIndex
//                               ? a.zeroLineIndex
//                               : 0)
//                               ? ((h = c.zeroLineWidth),
//                                 (g = c.zeroLineColor),
//                                 (m = c.zeroLineBorderDash),
//                                 (v = c.zeroLineBorderDashOffset))
//                               : ((h = i.getValueAtIndexOrDefault(
//                                   c.lineWidth,
//                                   n
//                                 )),
//                                 (g = i.getValueAtIndexOrDefault(c.color, n)),
//                                 (m = i.getValueOrDefault(
//                                   c.borderDash,
//                                   u.borderDash
//                                 )),
//                                 (v = i.getValueOrDefault(
//                                   c.borderDashOffset,
//                                   u.borderDashOffset
//                                 )));
//                             var x,
...
//                     }
//                     if (c.drawBorder) {
//                       (s.lineWidth = i.getValueAtIndexOrDefault(
//                         c.lineWidth,
//                         0
//                       )),
//                         (s.strokeStyle = i.getValueAtIndexOrDefault(
//                           c.color,
//                           0
//                         ));
//                       var R = a.left,
...
//                       p
//                         ? ((V = O = "top" === r.position ? a.bottom : a.top),
//                           (V += z),
//                           (O += z))
//                         : ((R = L = "left" === r.position ? a.right : a.left),
//                           (R += z),
//                           (L += z)),
//                         s.beginPath(),
//                         s.moveTo(R, V),
...
//                   ? e.scaleMerge(t.defaults.scale, this.defaults[n])
//                   : {};
//               },
...
//                     t.max &&
//                     t.stepSize &&
//                     e.almostWhole((t.max - t.min) / t.stepSize, i / 1e3) &&
//                     ((o = t.min), (l = t.max));
//                   var s = (l - o) / i;
//                   (s = e.almostEquals(s, Math.round(s), i / 1e3)
//                     ? Math.round(s)
//                     : Math.ceil(s)),
//                     a.push(void 0 !== t.min ? t.min : o);
//                   for (var u = 1; s > u; ++u) a.push(o + u * i);
...
//                   0 === l
//                     ? ((i = Math.floor(e.log10(n.minNotZero))),
//                       (a = Math.floor(n.minNotZero / Math.pow(10, i))),
//                       r.push(l),
//                       (l = a * Math.pow(10, i)))
//                     : ((i = Math.floor(e.log10(l))),
...
//                     (r = i), (i = v);
//                   }
//                   return { x1: i, x2: a, x3: r, y1: o, y2: l, y3: s };
//                 },
...
//                   if (i) {
//                     for (
//                       var a = e.getAngleFromPoint(i, { x: t, y: n }),
//                         r = a.angle,
//                         o = a.distance,
//                         l = i.startAngle,
//                         s = i.endAngle;
...
//                     h = -1;
//                   for (
//                     o._loop && d.length && d.push(d[0]),
//                       s.save(),
//                       s.lineCap = l.borderCapStyle || c.borderCapStyle,
//                       s.setLineDash &&
//                         s.setLineDash(l.borderDash || c.borderDash),
//                       s.lineDashOffset =
//                         l.borderDashOffset || c.borderDashOffset,
...
//                       (r = i._view),
//                       0 === t
//                         ? r.skip || (s.moveTo(r.x, r.y), (h = t))
//                         : ((a = -1 === h ? a : d[h]),
//                           r.skip ||
//                             ((h !== t - 1 && !u) || -1 === h
//                               ? s.moveTo(r.x, r.y)
//                               : e.canvas.lineTo(s, a._view, i._view),
//                             (h = t)));
//                   s.stroke(), s.restore();
//                 },
//               }));
...
//                     g = 0;
//                   n.skip ||
//                     ((l.strokeStyle = n.borderColor || r),
//                     (l.lineWidth = i.getValueOrDefault(
//                       n.borderWidth,
//                       a.elements.point.borderWidth
//                     )),
...
//                   var y = t(0);
//                   s.moveTo(y[0], y[1]);
//                   for (var k = 1; 4 > k; k++) (y = t(k)), s.lineTo(y[0], y[1]);
//                   s.fill(), d && s.stroke();
//                 },
//                 height: function () {
//                   var t = this._view;
...
//                   return (
//                     e(this)
//                       ? ((t = i.x), (n = (i.y + i.base) / 2))
//                       : ((t = (i.x + i.base) / 2), (n = i.y)),
//                     { x: t, y: n }
//                   );
//                 },
//                 getArea: function () {
...
//                 e && (e.parentNode.removeChild(e), (t._chartjs.resizer = null)),
//                   delete t._chartjs;
//               }
//             }
//             var s = t.helpers,
...
//                   return (
//                     (e = i.isHorizontal()), { x: e ? r : null, y: e ? null : r }
//                   );
//               }
//               return null;
//             }
...
//                   (g = r(h)),
//                   f && g
//                     ? ((x = v.push(c)), (y = b.push(h)))
//                     : x &&
//                       y &&
//                       (m
//                         ? (f && v.push(c), g && b.push(h))
//                         : (o(t, v, b, x, y), (x = y = 0), (v = []), (b = [])));
...
//                   generateLabels: function (t) {
//                     var e = t.data;
//                     return i.isArray(e.datasets)
//                       ? e.datasets.map(function (e, n) {
//                           return {
//                             text: e.label,
//                             fillStyle: i.isArray(e.backgroundColor)
//                               ? e.backgroundColor[0]
//                               : e.backgroundColor,
...
//                   if (
//                     (m
//                       ? ((p.width = n.maxWidth), (p.height = o ? 10 : 0))
//                       : ((p.width = o ? 10 : 0), (p.height = n.maxHeight)),
//                     o)
//                   )
//                     if (((l.font = f), m)) {
...
//                           v[v.length - 1] + o + r.padding >= n.width &&
//                             ((b += d + r.padding), (v[v.length] = n.left)),
//                             (g[i] = { left: 0, top: 0, width: o, height: d }),
...
//                         M + S > p.height &&
//                           ((k += w + r.padding), y.push(w), (w = 0), (M = 0)),
//                           (w = Math.max(w, a)),
//                           (M += S),
...
//                           ((l = d.y += M),
//                           d.line++,
//                           (o = d.x = n.left + (s - u[d.line]) / 2))
//                         : l + M > n.bottom &&
//                           ((o = d.x = o + n.columnWidths[d.line] + r.padding),
...
//                     o = e.legend;
//                   r
//                     ? ((r = i.configMerge(t.defaults.global.legend, r)),
//                       o ? (a.configure(e, o, r), (o.options = r)) : n(e, r))
//                     : o && (a.removeBox(e, o), delete e.legend);
//                 },
...
//           e.exports = function (t) {
//             function e(e, n) {
//               var a = new t.Title({ ctx: e.ctx, options: n, chart: e });
...
//                   e.isHorizontal()
//                     ? ((s.width = e.maxWidth),
//                       (s.height = o ? l + 2 * a.padding : 0))
//                     : ((s.width = o ? l + 2 * a.padding : 0),
...
//                           (s = p + (v - p) / 2),
//                           (u = b - m))
//                         : ((l = "left" === r.position ? m + d / 2 : b - d / 2),
//                           (s = p + (v - p) / 2),
//                           (u = v - p),
//                           (g = Math.PI * ("left" === r.position ? -0.5 : 0.5))),
//                       i.save(),
//                       i.translate(l, s),
//                       i.rotate(g),
//                       (i.textAlign = "center"),
...
//                     o = a.titleBlock;
//                   r
//                     ? ((r = n.configMerge(t.defaults.global.title, r)),
//                       o ? (i.configure(a, o, r), (o.options = r)) : e(a, r))
//                     : o &&
//                       (t.layoutService.removeBox(a, o), delete a.titleBlock);
//                 },
//               }
//             );
//           };
...
//                     ((i = e.indexOf(n, t.options.ticks.min)),
//                     (t.minIndex = -1 !== i ? i : t.minIndex)),
//                     void 0 !== t.options.ticks.max &&
//                       ((i = e.indexOf(n, t.options.ticks.max)),
...
//                         1 -
//                         r.minIndex -
//                         (r.options.gridLines.offsetGridLines ? 0 : 1),
//                       1
//                     );
//                   if (
//                     (void 0 !== t &&
//                       null !== t &&
//                       (a = r.isHorizontal() ? t.x : t.y),
...
//                       d = u * (e - r.minIndex);
//                     return (
//                       ((r.options.gridLines.offsetGridLines && i) ||
//                         (r.maxIndex === r.minIndex && i)) &&
//                         (d += u / 2),
//                       r.left + Math.round(d)
//                     );
//                   }
...
//                     h = c * (e - r.minIndex);
//                   return (
//                     r.options.gridLines.offsetGridLines && i && (h += c / 2),
//                     r.top + Math.round(h)
//                   );
//                 },
//                 getPixelForTick: function (t, e) {
...
//                         s = [
//                           l.type,
//                           void 0 === i.stacked && void 0 === l.stack ? o : "",
//                           l.stack,
//                         ].join(".");
//                       void 0 === c[s] &&
//                         (c[s] = { positiveValues: [], negativeValues: [] });
...
//                     );
//                   else {
//                     var r = e.getValueOrDefault(
//                       a.fontSize,
//                       t.defaults.global.defaultFontSize
//                     );
//                     n = Math.min(
//                       a.maxTicksLimit ? a.maxTicksLimit : 11,
//                       Math.ceil(i.height / (2 * r))
//                     );
//                   }
//                   return n;
//                 },
...
//                   (n.min = e.min(l)),
//                   a.reverse
//                     ? (l.reverse(), (n.start = n.max), (n.end = n.min))
...
//                               : i > n.max && (n.max = i),
//                             0 !== i &&
//                               (null === n.minNotZero || i < n.minNotZero) &&
//                               (n.minNotZero = i));
//                         });
//                     });
//                   (n.min = s(a.min, n.min)),
...
//                         ? ((n.min = Math.pow(
//                             10,
//                             Math.floor(e.log10(n.min)) - 1
//                           )),
//                           (n.max = Math.pow(
//                             10,
//                             Math.floor(e.log10(n.max)) + 1
//                           )))
//                         : ((n.min = 1), (n.max = 10)));
//                 },
//                 buildTicks: function () {
...
//                     (n.min = e.min(o)),
//                     a.reverse
//                       ? (o.reverse(), (n.start = n.max), (n.end = n.min))
//                       : ((n.start = n.min), (n.end = n.max));
//                 },
//                 convertTicksToLabels: function () {
...
//                           ? (i = r.left)
//                           : ((n = r.width),
//                             (i = r.left + (n / a) * (e.log10(l) - e.log10(o)))))
//                       : ((n = r.height),
//                         0 !== o || u.reverse
//                           ? 0 === r.end && u.reverse
...
//                                     0.02 * n +
//                                     ((0.98 * n) / a) *
//                                       (e.log10(l) - e.log10(r.minNotZero))))
//                             : 0 === l
//                             ? (i = u.reverse ? r.top : r.bottom)
//                             : ((a = e.log10(r.end) - e.log10(o)),
//                               (n = r.height),
//                               (i =
//                                 r.bottom - (n / a) * (e.log10(l) - e.log10(o))))
...
//                     a.isHorizontal()
//                       ? ((i = a.width),
//                         (n = a.start * Math.pow(10, ((t - a.left) * r) / i)))
//                       : ((i = a.height),
...
//               return { size: n, style: i, family: a, font: r };
//             }
//             function i(t, e, n) {
//               return f.isArray(n)
//                 ? {
...
//                 m.start < d.l && ((d.l = m.start), (c.l = g)),
//                   m.end > d.r && ((d.r = m.end), (c.r = g)),
//                   v.start < d.t && ((d.t = v.start), (c.t = g)),
//                   v.end > d.b && ((d.b = v.end), (c.b = g));
//               }
...
//               var r = t.ctx;
//               if (
//                 ((r.strokeStyle = f.getValueAtIndexOrDefault(n.color, a - 1)),
...
//                           h = t.yCenter - d;
//                         if (
//                           (n.display && 0 !== s && c(t, n, d, s), i.display)
//                         ) {
...
//                               r.fillRect(
//                                 t.xCenter - p / 2 - i.backdropPaddingX,
//                                 h - o / 2 - i.backdropPaddingY,
//                                 p + 2 * i.backdropPaddingX,
//                                 o + 2 * i.backdropPaddingY
//                               );
//                           }
//                           (r.textAlign = "center"),
...
//               function n(t, e, n, i) {
//                 for (
//                   var a, r = Object.keys(l), o = r.length, s = r.indexOf(t);
//                   o > s;
//                   s++
//                 ) {
//                   a = r[s];
...
//                 else for (; o > i && i > 0; ) ++s, (o = Math.ceil(u / (r * s)));
//                 return s;
//               }
//               function r(t, e, n) {
//                 var a = [];
...
//                       (a = a.valueOf()))
//                     : ((n = i(e.min).startOf(t.unit).valueOf()),
...
//                       var d = [];
//                       "object" == typeof l.data[0] &&
//                       null !== l.data[0] &&
//                       n.chart.isDatasetVisible(u)
//                         ? o.each(l.data, function (o, l) {
//                             var s = e(n, n.getRightValue(o));
//                             s.isValid() &&
//                               (i.round && s.startOf(i.round),
//                               (t = s.valueOf()),
//                               (a = Math.min(t, a)),
//                               (r = Math.max(t, r)),
//                               (d[l] = t));
...
//                       "object" == typeof r &&
//                       (a = i.getRightValue(r)),
//                     i.options.time.tooltipFormat &&
//                       (a = e(i, a).format(i.options.time.tooltipFormat)),
//                     a
//                   );
//                 },
...
//                     void 0 !== n &&
//                       void 0 !== i &&
//                       (r = a._parsedData.datasets[i][n]),
//                     null === r &&
//                       ((t && t.isValid) || (t = e(a, a.getRightValue(t))),
